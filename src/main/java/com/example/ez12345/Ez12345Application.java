...
public class Ez12345Application {
    ...
    public static void main(String[] args) {
        SpringApplication.run(Ez12345Application.class, args); // this line start the program
    }

    @PostMapping("/submitSignup")
    public ResponseEntity<Void> receiveSignupData(
        ...
        if (!password.equals(confirmPassword)) {
            return ResponseEntity.badRequest().build(); // Return 400 Bad Request if passwords don't match
        }
